					...
					<form method='post' action="models/siwesposting.php" enctype='multipart/form-data'>
						<fieldset>
							...
							<div id='thegentable'>
								...
								<input type="text" name="siwesOfficer" value='<?php echo $postrow['siwesOfficer']; ?>' disabled>
							...
							<div id='thenew'>
								...
								<input type="text" name="siwesOfficer" value='<?php echo $postrow['siwesOfficer']; ?>' required>
