			...
			<div class="col-sm-8 page-content">
				<div class="white-container mb0">
					<div id='thegentable' class='pb90'>
						<h6>All Work Done</h6>
						<?php
						if ($_SESSION['adminrole'] == "Administrator") {
						?><a href="#" id='shownew' class="btn btn-default">Add New Work Done</a>
							...
							<?php
								...
								<H3>NO SIWES COMPANY ASSIGNED YET</H3>
						<?php	}
						}
						...
						if (mysqli_num_rows($thelogs) == 0) { ?>
							<p class='pt20 mb90 pb210'>You have not added any word progress yet.</p>
							<?php
						} else { ?>						
									...
									<tbody>
										<?php while ($logrow = mysqli_fetch_array($thelogs)) { ?>
											<tr>
												...
												<td><?php echo $logrow['logbookComment']; ?>
			...
			<div class="col-sm-4 page-sidebar">
				<aside>
					<div class="widget sidebar-widget white-container links-widget">
						<ul><br>
							<div>&nbsp&nbsp&nbsp&nbsp Welcome <?php echo ucwords($fname . ' ' . $sname); ?></div>
